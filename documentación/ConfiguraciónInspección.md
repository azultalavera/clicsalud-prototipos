|  Clínicas  |  Geriátricos  |  CATEGORÍA/SERVICIO/SALA| SUBCATEGORÍA| SUBTÍTULO| DATO A INSPECCIONAR| TIPO DE DATO	
|  :---:  |  :---:  |  :---:| :---:| :---:| :---:| :---:| 	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | N° Expt. Digital| ALFANUMÉRICO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| | FECHA Y HORA| FECHA	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | FORMATO INSPECCIÓN| VIRTUAL/PRESENCIAL	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Nombre Establecimiento| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Razón Social| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Dirección| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Localidad| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Email| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Teléfono| NÚMERO	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | Nombre Inspector| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | DNI Inspector| NÚMERO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| | Radiofísica| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| | Tipo de Inspección| DESPLEGABLE	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| | Fecha de Habilitación| FECHA	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| | Resolución Nº| NÚMERO	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | DIRECTOR TÉCNICO| STRING	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | DNI DT| NÚMERO	
|  TRUE  |  TRUE  |  TIPOLOGÍA| DATOS GENERALES| | MATRÍCULA DT| NÚMERO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| REGISTROS| Registro de Historia Clínicas| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| REGISTROS| Tipo de Registros| MANUAL/DIGITAL/MIXTA	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| REVISIÓN| Revisión de Historias Clínicas| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| REVISIÓN| Completitud Historias Clínicas| COMPLETAS/INCOMPLETAS	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| REVISIÓN| Reglamento Interno/ Manual Procedimientos de la Institución/ Manual Procedimientos de los servicios| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| REVISIÓN| Aditamento privado/ Denominación correcta| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Cantidad de Plantas| NÚMERO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Fecha ultima inspección del conservador responsable| FECHA	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Posee Montacamillas/Ascensores| DESPLEGABLE	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Baño para público discapacitado mixtos| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Libre ingreso , circulación y giro de camillas| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Luces autónomas de emergencia| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Equipo Electrógenos| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| CONSULTORIOS EXTERNOS| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Cantidad total de consultorios| NÚMERO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Cantidad de consultorios con baño privada y vestuario| NÚMERO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Consultorio con lavabo| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Plan Evacuacion vigente| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Extinguidores de Incendios(vigente o no)| DESPLEGABLE	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Salida de Emergencia| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Habilitación Bomberos| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Silla de Ruedas| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Todas las camas tipo Ortopedia| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| Posee planos inclinados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| CONSULTORIOS SALUD MENTAL| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| FECHA VENCIMIENTO PLAN EVACUACION| FECHA	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| FECHA VENCIMIENTO BOMBEROS| FECHA	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| DATOS| FECHA VENCIMIENTO EXTINGUIDORES| FECHA	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| Diagnóstico por imagen habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| Densitometría ósea habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| TAC habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| Radiología simple habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| Ecografía habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| Mamografía habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| PET habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| RMN habilitados| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| RADIOFÍSICA| Radiología contrastada habilitados| SI/NO	
|  TRUE  |    |  TIPOLOGÍA| DATOS GENERALES| SECTOR DE INTERNACIÓN CUMPLE Y AREA DE RESIDUOS| Condiciones Edilicias| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| SECTOR DE INTERNACIÓN CUMPLE Y AREA DE RESIDUOS| Área de Residuos| SI/NO	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| LABORATORIO| Habilitación por Cobico| SI/NO	
|  TRUE  |    |  TIPOLOGÍA| DATOS GENERALES| LABORATORIO| Interno/Externo| BUTTON GROUP	
|  TRUE  |  FALSE  |  TIPOLOGÍA| DATOS GENERALES| LABORATORIO| Propio/Tercerizado| BUTTON GROUP	
...
"|  FALSE  |  TRUE  |  TIPOLOGÍA| | Articulo 25: Terminaciones| Cielorrasos superficie
continua| SI/NO"	
...
"|  FALSE  |  TRUE  |  TIPOLOGÍA| | Articulo 44: Instalación de agua| Agua caliente (caldera,
termotanque, calefón)
| SI/NO"	
...
|  TRUE  |  FALSE  |  QUIROFANO| ARQUITECTURA| | N° DE CAMAS| NÚMERO	
|  TRUE  |  FALSE  |  QUIROFANO| ARQUITECTURA| | Coincide con edificacion| SI/NO	
|  TRUE  |  FALSE  |  QUIROFANO| ARQUITECTURA| | Planos| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDADES DE TERAPIA INTENSIVA| | De los Edificios/Locales de la unidad| Depósito de camillas y aparatología| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDADES DE TERAPIA INTENSIVA| | De los Edificios/Locales de la unidad| Grupo electrógeno| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDADES DE TERAPIA INTENSIVA| | De los Edificios/Locales de la unidad| Doble comando| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| | De los Edificios/Locales de la unidad| Depósito de camillas y aparatología| SI/NO	
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| | De los Edificios/Locales de la unidad| Sala de médicos| SI/NO	
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| | De los Edificios/Locales de la unidad| Grupo electrógeno| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| | De los Edificios/Locales de la unidad| Doble comando| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| | De los Edificios/Locales de la unidad| Sistema de Iluminación de Emergencia| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| EQUIPAMIENTO| | Sistema portátil de aspiración o/drenaje| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD CORONARIA| EQUIPAMIENTO| | Sistema de aspiración torácica| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD DE TERAPIA INTENSIVA NEONATAL| | De los Edificios/Locales de la unidad| Sistema calefaccion refrigeracion| SI/NO	
...
|  TRUE  |  FALSE  |  UNIDAD DE TERAPIA INTENSIVA NEONATAL| EQUIPAMIENTO| | Sistema de aspiración torácica| NÚMERO	
...
|  TRUE  |  FALSE  |  UNIDAD DE TERAPIA INTENSIVA NEONATAL| EQUIPAMIENTO| | Sistema portátil de aspiración p/ drenaje| NÚMERO	
...
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Unidad de Dialisis Independiente| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Registro de Psicofarmacos Actualizado| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Registro de Enfermedades Trasmisibles| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Reglamento Interno| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Plan de Evacuacion| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Habilitacion de Bomberos| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Normas bioseguridad expuestas| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Normas de Procedimientos para Medicos| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Normas de Procedimientos para enfermeras| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Nro de Inscripcion de pacientes al INCUCAI y/o ECODAI:| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Carpetas de Inscripcion de pacientes al INCUCAI y/o ECODAI| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Convenio de Internacion| NÚMERO	
|  TRUE  |  FALSE  |  HEMODIALISIS| | De la Direccion y Funcionamiento| Registro Historia clinica completa| NÚMERO	
...
graph TD
    ...
    Root((Sistema de Inspección)) --> Clinicas{Clínicas}
    Root --> Geriatricos{Geriátricos}

    %% Ramificación Geriátricos
    Geriatricos --> G_Tipologia[CATEGORÍA: TIPOLOGÍA]
    G_Tipologia --> G_Art2[Artículos de Regulación 2 a 54]
    G_Art2 --> G_Datos[Datos Específicos: RRHH, Habitabilidad, Baños, Cocina, etc.]

    %% Ramificación Clínicas
    Clinicas --> C_Tipologia[CATEGORÍA: TIPOLOGÍA]
    Clinicas --> C_Guardia[CATEGORÍA: GUARDIA]
    Clinicas --> C_UCI[CATEGORÍA: UCI / UCO / UTI]
    Clinicas --> C_Quirofano[CATEGORÍA: QUIRÓFANO]
    Clinicas --> C_Otros[Otras Categorías: Hemodinamia, Hospital de Día, Diálisis]

    %% Ejemplo de desglose jerárquico (Subcategorías)
    C_Tipologia --> SC_Gen[Subcategoría: DATOS GENERALES]
    SC_Gen --> ST_Reg[Subtítulo: REGISTROS]
    SC_Gen --> ST_Rev[Subtítulo: REVISIÓN]
    SC_Gen --> ST_Rad[Subtítulo: RADIOFÍSICA]

    %% Nodo de Atributos (Dato a Inspeccionar)
    ST_Rad --> D1[Dato: Diagnóstico por imagen]
    ST_Rad --> D2[Dato: Tomografía - TAC]
    
    %% Definición de Tipos de Datos (Leyenda para DBAs)
    subgraph Tipos_de_Datos [Tipos de Datos en BD]
        direction LR
        T1[ALFANUMÉRICO / STRING]
        T2[FECHA / HORA]
        T3[NÚMERO / INTEGER]
        T4[SI/NO - BOOLEAN]
        T5[DESPLEGABLE / ENUM]
    ...
    style Clinicas fill:#bbf,stroke:#333
    style Geriatricos fill:#bfb,stroke:#333
    style Tipos_de_Datos fill:#fff,stroke-dasharray: 5 5