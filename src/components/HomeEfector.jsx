...
const HomeEfector = () => {
  ...
  const handleQAFill = () => {
    ...
    setEquiposCargados([
      ...
      {
        origen: "Quirófano",
        equipamiento: "Bisturí Eléctrico",
        marca: "Medtronic",
        modelo: "Force FX",
        serie: "SN112233",
      },
      {
        origen: "Unidad Coronaria",
  ...
  return (
    <Layout>
      ...
      >
        <Tabs
          value={
            currentPath.includes("observartramite")
              ? "/home-efector/observartramite"
              : currentPath.includes("actainspeccion")
                ? "/home-efector/actainspeccion"
        ...
        >
          <Tab
            label="VER TRÁMITE"
            value="/home-efector/vertramite"
            component={Link}
            to="/home-efector/vertramite"
            sx={{ fontWeight: "bold" }}
          />
          <Tab
            label="OBSERVAR TRÁMITE"
            value="/home-efector/observartramite"
            component={Link}
            to="/home-efector/observartramite"
            sx={{ fontWeight: "bold" }}
          />
          <Tab
            label="ACTA DE INSPECCIÓN"
            value="/home-efector/actainspeccion"
            component={Link}
            to="/home-efector/actainspeccion"
            sx={{ fontWeight: "bold" }}
          />
        </Tabs>
      </Box>
      ...
      >
{/* ENCABEZADO AZUL CONDICIONAL */}
  {!["observartramite", "actainspeccion"].some((p) =>
